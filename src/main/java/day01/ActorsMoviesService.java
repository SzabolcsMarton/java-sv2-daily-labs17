...
public class ActorsMoviesService {
    ...
    public void insertMovieWithActors(String title, LocalDate release_date, List<String> actorsName) {
        long movieId = moviesRepository.saveMovie(title, release_date);
        for (String actual : actorsName) {
            long actorId;
